...
資料内では、重要度や作業の種類が一目で分かるように、次のラベルを使います。

| ラベル | 意味 | 読むときの意識 |
| --- | --- | --- |
| 🟦 概念 | 仕組みとして理解するところ | 先に図と流れをつかむ |
| 🟩 実装 | 実際にコードを書くところ | どのファイルに書くか確認する |
| 🟨 確認 | 動作確認するところ | Bruno、ブラウザ、ログで見る |
| 🟥 注意 | 詰まりやすいところ | エラー時に戻って読む |
| ⬜ 参考 | 余裕があれば見るところ | 必要になったら読む |
